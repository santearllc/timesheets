...
export class ApprovalComponent implements OnInit {
  ...
  ngOnInit() {
    this.approvals.push({ name: 'Shows' });
    this.approvals.push({ name: 'Departments' });
  ...
  generateTimeSheet(timesheet) {
    ...
    for (var prop_1 in timesheet) {
          ...
          if (prop_2 != 'Hours') {
            ...
            for (var prop_3 in timesheet[prop_1][prop_2]) {
              ...
              if (prop_3 != 'Hours') {
                ...
                children[2].push({ title: this.users[prop_3].FullName, cat_key: prop_3, hours: timesheet[prop_1][prop_2][prop_3]['Hours'], children: children[3], sum_hours: sum_hours, rejected: false, rejected_by: false, rejected_note: '', rejected_hover : false, approved: false, approved_by: false, approved_dated: false, ot: ot, showNote : false })
                ...
                for (var prop_4 in timesheet[prop_1][prop_2][prop_3]) {
                  ...
                  if (prop_4 != 'Hours') {
                    ...
                    children[3].push({ title: '', cat_key: prop_4, note: '', hours: timesheet[prop_1][prop_2][prop_3][prop_4]['Hours'], children: children[4], showNote : false })
                    ...
                    for (var prop_5 in timesheet[prop_1][prop_2][prop_3][prop_4]) {
                      if (prop_5 != 'Hours') {
                        children[5] = [];
                        children[4].push({ title: '', cat_key: prop_5, note: '', hours: timesheet[prop_1][prop_2][prop_3][prop_4][prop_5]['Hours'], children: children[5], showNote : false })

                        for (var prop_6 in timesheet[prop_1][prop_2][prop_3][prop_4][prop_5]) {
                          if (prop_6 != 'Hours') {

                            children[5].push({ title: '', cat_key: prop_6, note: '', hours: timesheet[prop_1][prop_2][prop_3][prop_4][prop_5][prop_6]['Hours'], children: [], showNote : false  });
      ...
      this.timesheet_2.push({ title: this.titles[prop_1].Title, cat_key: prop_1, children: children[1] });
    }
  }


  sumTimeSheet() {
    console.log('sumTimesheet')
  ...
  rejected(event, el) {
    ...
    if (el['rejected']) {
      ...
      $('#rejected_note_popup').find('.popup_text').html('<textarea style="width:100%;resize:none;height:100px;">' + this.user_focused_el['rejected_note'] + '</textarea>')
  ...
  unapprovalConfirmed(event) {
    var par_obj = $('#confirm_unapproval_popup')
